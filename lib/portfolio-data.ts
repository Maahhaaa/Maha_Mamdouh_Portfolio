...
export const projects = [
  ...
  },
  {
    ...
    subtitle: "Full-Stack Medical Portal",
    description:
      "A scalable, modern medical portal built using the MEAN Stack, featuring patient medical profiles, staff scheduling, and secure authentication.",
    longDescription:
      "Full-Stack Group Project developed using MongoDB, Express.js, Angular, and Node.js. Modeled relational structures for patient medical profiles and implemented authorization and secure REST APIs for staff scheduling.",
    technologies: ["MongoDB", "Express.js", "Angular", "Node.js", "REST APIs", "TypeScript"],
    features: [
      "Patient medical profile management",
      "Staff scheduling with authorization",
      "Secure REST API endpoints",
      "Role-based access control",
      "Real-time dashboard updates",
    ],
    challenges: "Designing a secure and scalable multi-role authorization system for hospital staff.",
    solution: "Implemented JWT-based authentication with role-based route guards in Angular and middleware validation in Express.js.",
    ...
    previewUrl: null,
    color: "#FF3CAC",
    tags: ["MEAN Stack", "Healthcare", "Full-Stack", "Group Project"],
  },
  {
    id: 3,
    title: "Flutter Showcase App",
    subtitle: "Cross-Platform Portfolio Demo",
    description:
      "A placeholder Flutter Web application showcasing responsive UI, animations, and Firebase integration. Add your deployed Flutter Web URL here.",
    longDescription:
      "This is a placeholder for an additional Flutter Web project. Replace the previewUrl with your deployed Vercel/Firebase Hosting URL to embed the live app inside the phone mockup.",
    ...
    challenges: "[ Add your project challenges here ]",
    ...
    previewUrl: null,
    color: "#7B2CBF",
    tags: ["Flutter Web", "Firebase", "Placeholder"],
  },
];
