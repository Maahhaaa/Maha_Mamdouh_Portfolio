...
import { ExternalLink, Github, BookOpen, X, ChevronLeft, ChevronRight, Smartphone, Monitor } from 'lucide-react';
        ...
        <div className="p-5 md:p-8 grid md:grid-cols-2 gap-8">
          ...
          <div className="flex flex-col items-center">
            ...
            <div className="flex flex-wrap gap-2 mt-6 justify-center">
              ...
              <DetailButton href="#" icon={<BookOpen className="w-3 h-3" />} label="CASE STUDY" color="#7B2CBF" />
            </div>
          </div>
